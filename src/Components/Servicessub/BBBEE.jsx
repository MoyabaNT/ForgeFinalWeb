...
const BBBEE = () => {
  return (
    ...
    <div className="bg-gradient-to-b from-gray-300 va-gray-200 to-gray-300 min-h-screen flex flex-col">
      {/** Logo and Sidebar */}
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="bg-gradient-to-b from-gray-300 to-gray-300 rounded-lg shadow-md p-8 max-w-3xl w-full text-center">
